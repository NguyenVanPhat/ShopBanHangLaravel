	...
	<div class="w3layouts-main">
		<h2>Đăng Ký</h2>
			...
			<form action="{{URL::TO('/register') }}" method="post">
                ...
                @endforeach
                <input type="text" value="{{ old('admin_name') }}" class="ggg" name="admin_name" placeholder="Vui Lòng Nhập Tên " >
                <input type="text" value="{{ old('admin_name') }}" class="ggg" name="admin_phone" placeholder="Vui Lòng Nhập Số Điện Thoại" >
				<input type="text" value="{{ old('admin_name') }}" class="ggg" name="admin_email" placeholder="Điền Email!!!!!!!!" >
				<input type="password"  value="{{ old('admin_name') }}" class="ggg" name="admin_password" placeholder="Điền PassWord!!!!!!!!" >
