	...
	<div class="w3layouts-main">
		<h2>Đăng Nhập Authentication</h2>
			...
			<form action="{{URL::TO('/login') }}" method="post">
                ...
                @endforeach
				<input type="text" value="" class="ggg" name="admin_email" placeholder="Điền Email!!!!!!!!" >
				<input type="password"  value="" class="ggg" name="admin_password" placeholder="Điền PassWord!!!!!!!!" >
