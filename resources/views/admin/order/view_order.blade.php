        ...
        @foreach($order_details as $key => $details)
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>
              ...
              <input type="hidden" name="order_qty_storage" class="order_qty_storage_{{$details->product_id}}" value="{{$details->product_sales_quantity}}">
        ...
        @endforeach
          <tr>
            ...
            @php 
              ...
              @else 
                  @php
                  echo 'Tổng giảm :'.number_format($coupon_money,0,',','.').'k'.'</br>';
                  $total_coupon = $total + $details->product_feeship - $coupon_money ;
